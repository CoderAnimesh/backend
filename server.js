...
app.use(
  cors({
    origin: ["https://quantumquirksuoa.co.in", "https://quantumquirksuoa.netlify.app", "http://localhost:5173"],
    credentials: true,
  })
);
...
app.use(
  "/gallery",
  (req, res, next) => {
    res.setHeader("Access-Control-Allow-Origin", "https://quantumquirksuoa.co.in"); // Update with your actual frontend URL
...
// Note: If using the free tier of Resend, you can only send to your own registered email 
// unless you verify a domain. 'onboarding@resend.dev' works for testing if you send to yourself.
// Ideally, verify 'quantumquirksuoa.co.in' on Resend.
...
app.post("/api/participants/enroll", async (req, res) => {
  try {
    ...
    // ✅ Generate QR Code as Data URL for Resend (Base64)
    const qrDataUrl = await QRCode.toDataURL(finalCode, {
      type: "image/png",
      width: 200,
      margin: 2,
    ...
    // Also create buffer if you want to attach it as a file
  ...
  <tr>
    <td align="center" style="padding:20px; font-size:14px; color:#333333; border-bottom:1px solid #eeeeee;">
      ...
      <img src="${qrDataUrl}" alt="QR Code" width="150" height="150" style="margin-top:10px; display:block; margin-left:auto; margin-right:auto;" />
    </td>
  </tr>
  ...
  <tr>
    <td align="center" bgcolor="#f9fafb" style="padding:15px; font-size:12px; color:#555555;">
      ...
      Please keep this email safe and show your QR code or unique code at the event entrance.
        ...
        // Attachment is optional since we embedded it, but good for saving
        attachments: [
          {
            filename: "qrcode.png",
            content: qrBuffer, // Resend handles Buffer content
          },
        ],
      });
    } catch (mailErr) {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: `
        ...
        <p>Please <b>keep this information safe</b> and log in to the volunteer dashboard.</p>
      ...
      html: `
        <div style="font-family: Arial, sans-serif; background: #f9f9f9; padding: 20px;">
          <div style="max-width: 600px; margin: auto; background: #ffffff; padding: 20px; border-radius: 8px;">
            <h2 style="color: #4f46e5; text-align: center;">Welcome to Quantum Quirks 🚀</h2>
            <p>Hello <b>${name}</b>,</p>
            <p>You have been added as an <b>Organizer</b>.</p>
            <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
              <tr><td style="padding: 8px;"><b>Username</b></td><td style="padding: 8px;">${username}</td></tr>
              <tr><td style="padding: 8px;"><b>Email</b></td><td style="padding: 8px;">${email}</td></tr>
              <tr><td style="padding: 8px;"><b>Password</b></td><td style="padding: 8px;">${password}</td></tr>
            </table>
